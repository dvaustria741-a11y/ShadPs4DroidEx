...
const shad = JSON.parse(readFileSync(resolve(projectRoot, "app/src/main/resources/runtime-settings/shadps4.json"), "utf8"));
const box64 = JSON.parse(readFileSync(resolve(projectRoot, "app/src/main/resources/runtime-settings/box64.json"), "utf8"));
