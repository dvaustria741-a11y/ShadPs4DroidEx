...
test("Sonic packages and selects the native ARM64 FEX runtime without replacing Box64", () => {
  ...
  const profile = read("app/src/main/kotlin/Ali/kytyps4/RuntimeLaunchProfileProvider.kt");
  const launcher = read("app/src/main/kotlin/Ali/kytyps4/runtime/process/RuntimeProcessLauncher.kt");
  const service = read("app/src/main/kotlin/Ali/kytyps4/service/EmulationService.kt");
