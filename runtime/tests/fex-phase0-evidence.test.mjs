...
const apk = resolve(root, "app/build/outputs/apk/playstore/debug/app-playstore-debug.apk");
...
test("FEX Phase 0 evidence rejects invalid device, source, run, privacy, and artifact data", () => {
  ...
  reject((evidence) => ({ ...evidence, source: { ...evidence.source, projectRevision: "Ali.kytyps4/files" } }));
