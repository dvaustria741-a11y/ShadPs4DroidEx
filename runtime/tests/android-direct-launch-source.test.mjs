...
test("debug APK exposes a generic ADB game launcher without another launcher icon", () => {
  const activity = read(
    "app/src/debug/kotlin/Ali/kytyps4/DirectLaunchActivity.kt",
  );
  const mainActivity = read(
    "app/src/main/kotlin/Ali/kytyps4/MainActivity.kt",
  );
  const manifest = read("app/src/debug/AndroidManifest.xml");
